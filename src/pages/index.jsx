        ...
        <section className="page__carousel-grid">
          ...
          <div className="page__carousel-grid--content">
            ...
            <p>
              ...
              nisi scelerisque eu ultrices vitae auctor. Orci nulla pellentesque
              dignissim enim sit amet venenatis. Lacus sed turpis tincidunt id
              aliquet risus feugiat. Et pharetra pharetra massa massa ultricies.
              Suscipit adipiscing bibendum est ultricies integer quis auctor
              elit. Velit egestas dui id ornare arcu odio ut sem. Curabitur
              vitae nunc sed velit dignissim. Sit amet commodo nulla facilisi
              nullam vehicula. Eget dolor morbi non arcu risus quis varius. Nec
              ullamcorper sit amet risus nullam eget. Facilisis gravida neque
